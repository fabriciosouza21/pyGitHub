...
from quantidadeSentecas import quantidadeSentecas

class TestQuantidadeSentecas(unittest.TestCase):
    ...
    def testSentecasNaoAtribuidas(self):
        ...
        result = quantidadeSentecas(mockResultIbmWatson)
        sentecasNaoAtribuidasEsperadas = 5
