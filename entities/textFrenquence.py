...
class TextFrequence:
	...
	def get_text_current_offset(self):
		return self.text_current_step*self.text_break
	...
	def get_text_current(self):
		...
		elif(self.get_text_current_offset() < len(self.text) and self.get_text_limit() > len(self.text)):
	...
	def next_offset(self):
		if(self.text_current_step*self.text_break < len(self.text)):
			...
			raise IndexError("TextFrequence: next_offset: text_current_step is out of range")
